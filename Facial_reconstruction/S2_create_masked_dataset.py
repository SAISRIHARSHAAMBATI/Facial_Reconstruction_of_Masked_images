...
def overlay_masks():
    ...
    for image in ORG.image_dict['original']:
        ...
        # res_x = compute_distance(e_x, e_y, w_x, w_y)
        # res_y = compute_distance(n_x, n_y, s_x, s_y)
        res_x = abs(e_x - w_x)
        res_y = abs(n_y - s_y)
        ...
        # 
        # bg = pygame.image.load('images\\original\\2.PNG')
        #print(image_name)
        ...
        for mask_type in masks:
            ...
            DEFAULT_IMAGE_SIZE = (res_x*width*1, res_y*height*1.1)
            ...
            # print(bg2.get_width())
            bg2 = pygame.transform.scale(bg2, DEFAULT_IMAGE_SIZE)
            
            #print(mask_type, str(DEFAULT_IMAGE_SIZE))
